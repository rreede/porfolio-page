...
<div className="left-bottom-container mr-10 text-center">
     <Link to='/project'><button className='bg-blue-500 px-6 py-3 rounded-2xl text-white font-bold w-sm'>Click to see my latest webshop project!<br/><small>(Built with ReactJS, TypeScript and Tailwind)</small></button></Link>
