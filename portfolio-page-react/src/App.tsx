...
<div className="left-bottom-container mr-10 text-center">
     <Link to='/project'><button className='bg-blue-500 px-6 py-3 rounded-2xl text-white font-bold w-sm portfolio-project-btn'>Click to see my latest webshop project!<br/><small>(Built with ReactJS, TypeScript and Tailwind)</small></button></Link>

<div className="links mt-6 w-full">
  <a href="https://www.linkedin.com/in/rene-reede/" target='_blank'><button className='mt-6 bg-gray-700 rounded-md text-white py-3 px-3 mr-6 link-btn'>LinkedIn</button></a>
  <a href="https://github.com/rreede" target='_blank'><button className='mt-3 bg-gray-700 rounded-md text-white py-3 px-3 link-btn'>GitHub</button></a>
</div>
</div>
</div>
        <div className="bottom-container">
          ...
          <div className="right-bottom-container">
            ...
            <p>
          My core skills include:<br/> <strong>HTML</strong>, <strong>CSS</strong> (Tailwind), <strong>JavaScript</strong>, <strong>TypeScript</strong> and <strong>React.js</strong>.
