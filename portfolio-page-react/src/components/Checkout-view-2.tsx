    ...
    return(
        <>
            ...
            <div className="buttons flex justify-between gap-6">
              <Link to='checkout-3'><button className='bg-yellow-500 rounded-md py-3 px-6 text-white'>Back to Shopping Cart</button></Link>
              <Link to='checkout-3'><button className='bg-green-500 rounded-md py-3 px-6 text-white'>Choose Payment method</button></Link>
              </div>
            </div>
